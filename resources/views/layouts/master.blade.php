...
<body>
                        ...
                        <nav class="main-menu">
                            <ul>
                                ...
                                @if (Auth::user() && Auth::user()->role == 'admin')
                                    <li><a href="{{ route('categories.add') }}">إضافة قسم</a></li>
                                    <li><a href="{{ route('add.product') }}">إضافة منتج</a></li>
                                @endif
                                <li><a href="{{ route('all_products') }}">كل المنتجات</a></li>
                                <li><a href="{{ route('reviews.show') }}">أراء العملاء</a></li>
                                <li><a href="{{ route('products.table') }}">جدول المنتجات</a></li>
                                <li><a href="{{ route('checkout.previous') }}">الطلبات السابقه</a></li>
                                @guest
                                    @if (Route::has('login'))
                                        <li class="nav-item">
    ...
    <form action="{{ route('language.change', 'ar') }}" method="POST">
        @csrf
        <button type="submit">عربى</button>
    </form>
